...
import { createProperty, editProperty } from "@/redux/actions/propertyActions";
import { useRouter } from 'next/navigation'
import { useFetchData } from "../fetch-data";

// import { cookies } from "next/headers";
const UpdatePropertyTabContent = ({ id }) => {
    ...
    if (property) {
      setFormData({
        description: {
          ...
          rent_price: property?.price?.rent_price || "",
        ...
        details: {
          ...
          start_date: property?.availability?.start_date || "",
          forRent: property?.availability?.forRent || false,
        },
...
export default UpdatePropertyTabContent;
